...
BOSS_ID = "boss_05"
BOSS_NAME = "boss_05_mirrorpool_bride"
BOSS_ZH = "镜池新娘"
BOSS_EN = "Mirrorpool Bride"
...
PREVIEW_PATH = ARTIFACT_ROOT / "boss05_directional_contact.png"
...
ACTION_LOOP = {
    "walk": True,
    "attack": False,
    "boss_05_atk_01": False,
    "boss_05_atk_02": False,
    "boss_05_atk_03": False,
}
...
def main() -> None:
    ...
    print(
        "BOSS05_DIRECTIONAL_ASSETS_BUILT "
...
def build_animation_specs() -> list[tuple[str, float, bool, list[str]]]:
    ...
    for action_name in ("boss_05_atk_01", "boss_05_atk_02", "boss_05_atk_03"):
...
def update_attack_metadata(manifest: dict[str, Any]) -> None:
    names = {
        "boss_05_atk_01": ("铜根布道", "Copperroot Sermon", "铜色圣纹根脉冲", "Copper Sigil Root Pulse"),
        "boss_05_atk_02": ("圣椅倾轧", "Throne Crush Benediction", "金铜圣柱冲击", "Gilded Copper Pillar Impact"),
        "boss_05_atk_03": ("烛冠审判", "Candle-Crown Judgment", "铜绿烛火柱", "Verdigris Candle Flame Pillar"),
    }
